    ...
    public class RoleConfiguration : IEntityTypeConfiguration<IdentityRole>
    {
        public void Configure(EntityTypeBuilder<IdentityRole> builder)
        {
            builder.HasData(
                ...
                new IdentityRole { Id = "2", Name = SD.HealthFacilitiesAdministrator, NormalizedName = "HEALTHFACILITIESADMINISTRATOR" },
                new IdentityRole { Id = "3", Name = SD.HealthFacilityManager, NormalizedName = "HEALTHFACILITYAMANAGER" },
