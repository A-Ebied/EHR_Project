        ...
        public void Configure(EntityTypeBuilder<Medication> builder)
        {
            builder.HasData(
                new Medication
                {
                    ...
                    ImageUrl = "/images/Medication/fexofenadine.jpg",
                ...
                new Medication
                {
                    ...
                    ImageUrl = "/images/Medication/NASONEX.jpg",
                    CreatedAt = DateTime.Now,
                    UpdatedAt = DateTime.Now,
                },
                new Medication
                {
                    ...
                    ImageUrl = "/images/Medication/advance.jpg",
                    CreatedAt = DateTime.Now,
                    UpdatedAt = DateTime.Now,
                },
                new Medication
                {
                    ...
                    ImageUrl = "/images/Medication/Kerovit.jpg",
                    CreatedAt = DateTime.Now,
                    UpdatedAt = DateTime.Now,
                });
        }
